...
// A component to notify users about local storage usage
...
export const LocalStorageInfoButton = () => {
  ...
  return (
    <div className="relative">
      ...
      {showInfo && (
        <div className="absolute right-0 bottom-full mb-2 w-64 bg-white shadow-lg rounded-md p-3 border border-gray-200 z-10">
